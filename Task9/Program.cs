...
namespace Task9
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            books.Add(new Book("The Hobbit, or There and Back Again", "Tolkien", 310, 1937));
            books.Add(new Book("Jurassic Park", "Crichton", 400, 1990));
            books.Add(new Book("Harry Potter and the Prisoner of Azkaban", "Rowling", 462, 1999));
